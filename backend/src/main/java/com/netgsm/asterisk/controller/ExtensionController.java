...
public class ExtensionController {
    ...
    @GetMapping public Page<ExtensionResponse> list(@RequestParam(required = false) Long tenantId, @ParameterObject Pageable page) { return service.list(tenantId, page); }
