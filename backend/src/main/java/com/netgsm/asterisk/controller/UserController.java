...
public class UserController {
    ...
    @GetMapping("/tenants/{tenantId}/users") public Page<UserResponse> list(@PathVariable Long tenantId, @ParameterObject Pageable page) { return service.list(tenantId, page); }
