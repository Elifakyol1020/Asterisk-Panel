...
<style scoped>
.cdr-banner{display:flex;gap:20px;align-items:center;padding:28px;margin-bottom:24px;border:1px solid #efdfcc;border-radius:12px;background:linear-gradient(115deg,#fff6e9,#fffdf9)}.cdr-icon{display:grid;place-items:center;flex-shrink:0;width:54px;height:54px;border-radius:14px;background:#ffead2;color:#c77b35}.cdr-eyebrow{font-size:10px;font-weight:700;letter-spacing:.14em;color:#b18051}.cdr-banner h2{font-size:23px;margin:5px 0;color:#49382b}.cdr-banner p{font-size:13px;color:#8b7764}.cdr-total{margin-left:auto;text-align:right;white-space:nowrap}.cdr-total strong{display:block;font-size:36px;color:#694a30}.cdr-total span{font-size:12px;color:#9b8169}.cdr-filters{padding:22px;border-bottom:1px solid var(--line);background:#fcfdfe}.cdr-filters fieldset{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;border:0;padding:0;margin:0}.cdr-filters label{display:grid;gap:7px;font-size:12px;color:#66758a}.cdr-filters input,.cdr-filters select{width:100%;min-width:0;min-height:40px}.cdr-filter-footer{grid-column:1/-1;display:flex;justify-content:space-between;align-items:center;gap:15px}.cdr-filters .cdr-checkbox{display:flex;flex-direction:row;align-items:center;gap:8px}.cdr-checkbox input{width:16px;min-height:16px}.cdr-advanced{grid-column:1/-1;font-size:12px;color:#78879c}.cdr-advanced summary{cursor:pointer}.cdr-advanced>div{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;padding-top:15px}.cdr-message{padding:55px 24px;display:flex;align-items:center;flex-direction:column;gap:14px;text-align:center;color:var(--muted)}.cdr-message p{font-size:14px;max-width:540px}.cdr-error-text{color:#ac4f43;font-size:13px;margin-top:16px}.cdr-unanswered{background:#fff2da;color:#a5762a}.cdr-failed{background:#fcebea;color:#af5048}.cdr-time{font-variant-numeric:tabular-nums}.cdr-row{cursor:pointer}.cdr-row:hover{background:#fffaf3}.cdr-guide{display:flex;align-items:flex-start;gap:10px;padding:20px 4px;color:#7d899b;font-size:12px;line-height:1.7}.cdr-guide svg{flex-shrink:0;margin-top:2px}.cdr-guide strong{color:#5c6a7e}.cdr-modal{width:min(750px,calc(100vw - 32px));max-height:85vh;overflow:auto}.cdr-modal header{display:flex;justify-content:space-between;align-items:flex-start}.cdr-modal dl{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:24px}.cdr-modal dt{font-size:11px;color:#7b899c;margin-bottom:7px}.cdr-modal dd{margin:0;font-size:13px;overflow-wrap:anywhere;color:#344158}.cdr-detail-note,.cdr-limit{font-size:12px;padding-top:20px;color:var(--muted)}.cdr-limit{padding:16px 22px}.cdr-sr{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%)}@media(max-width:1100px){.cdr-filters fieldset{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.cdr-banner{padding:20px;gap:12px;flex-wrap:wrap}.cdr-banner h2{font-size:20px}.cdr-total{width:100%;text-align:left;padding-top:14px;border-top:1px solid #efdfcc}.cdr-total strong{font-size:28px}.cdr-filter-footer{align-items:flex-start;flex-direction:column}.cdr-filters fieldset,.cdr-advanced>div,.cdr-modal dl{grid-template-columns:1fr}.cdr-filter-footer .actions{width:100%}.cdr-filter-footer button{flex:1}}
</style>
