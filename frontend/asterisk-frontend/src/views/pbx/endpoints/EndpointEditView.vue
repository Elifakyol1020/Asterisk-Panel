...
import EndpointFields from '@/components/endpoints/EndpointFields.vue'
...
<template>
  <PageHeader title="Endpoint düzenle" :description="config.description">
  ...
  <div v-else-if="ready" class="form-layout">
    <form class="form-panel" @submit.prevent="save">
      ...
      <div class="form-grid">
        ...
        <EndpointFields :form="form" :errors="validation" :disabled="saving" editing />
      </div>
