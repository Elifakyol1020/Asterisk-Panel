...
<template>
  <PageHeader title="Gelen arama kuralı oluştur" :description="config.description">
  ...
  <div v-else-if="ready" class="form-layout">
    <form class="form-panel" @submit.prevent="save">
      ...
      <div class="form-grid">
        ...
        <InboundRouteFields :scope="scope" :targets="targets" :lookup-loading="lookupLoading" :form="form" :errors="validation" :disabled="saving" />
      </div>
